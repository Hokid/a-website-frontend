...
;(function(API, $) {
   ...
   * Если всё прошло успешно, то функция должна вернуть скрытые элементы.
   *
   * @param  {jObject} $items
   ...
   * Если всё прошло успешно, то функция должна вернуть показанные элементы.
   *
   * @param  {jObject} $items
   * @return {jObject, undefined}
   */
